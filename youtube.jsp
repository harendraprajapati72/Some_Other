    ...
    <section class="home1" id="home">
        <div class="max-width">
            <div class="home-content">
                ...
                <a href="youtube.jsp">YOUTUBE TIPS</a><br><br><br><br><br>
...
<section class="content1" id="">
    <p><h1 align="center">WELCOME TO YOUTUBE TUTORIAL</h1></p><br><br><br>
    <div class="max-width">
        <div  class="home-content">
             <a href="https://youtu.be/uCM8lDTniHc">
                        <img src="images/youtube music without subscription.jpg" 
                             width="100" 
                             height="100" /></a>               
        </div>
    </div>
